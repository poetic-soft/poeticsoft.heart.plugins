...
use Poeticsoft\Heart\Admin\Pages\DashboardPage;
use Poeticsoft\Heart\Admin\Pages\SmtpPage;
use Poeticsoft\Heart\Admin\Pages\AiAgentsPage;
...
class MenuController {
	...
	public function register_menus() {
		...
		add_menu_page(
			...
			'manage_options',
			$parent_slug,
			[ Base::get( DashboardPage::class ), 'render' ],
			'dashicons-heart',
			30
		);
