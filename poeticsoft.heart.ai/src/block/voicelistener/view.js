...
document.addEventListener('DOMContentLoaded', () => {
    const containers = document.querySelectorAll('.wp-block-poeticsoft-heart-ai-voicelistener');
    console.log(containers)
    containers.forEach(container => {
        const button = container.querySelector('.pshai-voice-btn');
        const output = container.querySelector('.pshai-voice-output');
        const status = container.querySelector('.pshai-voice-status');
