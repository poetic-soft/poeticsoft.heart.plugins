...
export default function Edit( { clientId, attributes, setAttributes } ) {
    ...
    const voiceOptions = [
        { label: __( 'Voz por defecto del sistema', 'poeticsoft-heart-ai' ), value: '' },
        ...voices.map(v => ({
            label: `${v.name} (${v.lang})`,
            value: v.voiceURI
        }))
    ...
    return (
        <Fragment>
            <InspectorControls>
                <PanelBody title={ __( 'Configuración de Altavoz', 'poeticsoft-heart-ai' ) }>
                    <TextControl
            ...
            <div { ...blockProps }>
                <div className="psh-speaker-preview">
                    <div className="psh-speaker-header">
                        ...
                        <strong>{ __( 'Voice Speaker (Text to Speech)', 'poeticsoft-heart-ai' ) }</strong>
                    </div>
