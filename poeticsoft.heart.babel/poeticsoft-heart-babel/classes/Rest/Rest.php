...
namespace Poeticsoft\Heart\Babel\Rest;

use Poeticsoft\Heart\Babel\Babel;
use Poeticsoft\Heart\Babel\Rest\Endpoints\SystemEndpoint;
use Poeticsoft\Heart\Babel\Rest\Endpoints\UploadEndpoint;
...
class Rest
{
    ...
    {
        $this->namespace = Babel::API_NAMESPACE;
    }
    ...
    {
        $instance = Babel::get($section_class);
